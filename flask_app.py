...
#gameTable = Game.query.order_by(desc(Game.price)).all()
    ...
    if 'gamename' in request.form and 'sgenre' in request.form:
        ...
        return render_template("main_page.html", comments=Comment.query.all(),
         games=Game.query.all(), genres=genrelist, avgprice=myAvg.average, users=User.query.all(), results=searchResults, curr="sgenre", curval =request.form["sgenre"])
        ...
        return render_template("main_page.html", comments=Comment.query.all(),
         games=Game.query.all(), genres=genrelist, avgprice=myAvg.average, users=User.query.all(), results=searchResults, curr="gamename", curval =request.form["gamename"] )
